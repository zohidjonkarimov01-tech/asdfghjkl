...
//   {name: "Mercury", age: 10},
// ]
// let user = users.find(u => u.age > 15);
// console.log(user);
...
// let arr = [1, 2, 3,4];
// let doubled = arr.filter(x => x % 2 === 0);
// console.log(doubled);
...
// let arr = ["a", "s", "d"];
// console.log(arr);
// console.log(arr.join(" mars "));

// let arr = [4, 2, 1, 3, 5];


// let name = prompt("Boshlanishda Arryning:4");
// let letter = prompt("sizning arrayingizdan malumotlarni olib tashlamoqchimiz");
...
let isConfirm = confirm("sizning arrayingizdan malumotlarni olib tashlamoqchimiz");

if (isConfirm) {
  fruits.pop();

  alert(`Arryning uzunligi: ${fruits.length}`);
